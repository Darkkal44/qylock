...
Rectangle {
    ...
    readonly property color green:       "#ffaa00"
    readonly property color greenDim:    "#aa7700"
    readonly property color greenDark:   "#1a0d00"
    readonly property color greenBright: "#ffcc88"
    readonly property color amber:       "#ffffff"
    readonly property color red:         "#ff4444"
    readonly property color gray:        "#443322"
    readonly property color phosphor:   "#ffaa00"
