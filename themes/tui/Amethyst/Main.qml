...
Rectangle {
    ...
    readonly property color green:       "#aa88ff"
    readonly property color greenDim:    "#7755aa"
    readonly property color greenDark:   "#0d001a"
    readonly property color greenBright: "#cc88ff"
    readonly property color amber:       "#50fa7b"
    readonly property color red:         "#ff4444"
    readonly property color gray:        "#332244"
    readonly property color phosphor:   "#aa88ff"
