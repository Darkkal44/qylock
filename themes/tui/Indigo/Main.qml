...
Rectangle {
    ...
    readonly property color greenDim:    "#0077aa"
    readonly property color greenDark:   "#000d1a"
    readonly property color greenBright: "#88ccff"
    readonly property color amber:       "#6272a4"
    readonly property color red:         "#ff4444"
    readonly property color gray:        "#112233"
    ...
    readonly property color phosphor:   "#00aaff"
