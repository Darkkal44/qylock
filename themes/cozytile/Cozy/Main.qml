...
Rectangle {
    ...
    // Colors - Cozy Theme
    readonly property color accent:     "#CAA9E0" // Lavender
    readonly property color panelBg:    "#dd1e1e2e"
    ...
    // ── Falling Petals Animation (Unified with Sakura Style) ──────────
    Repeater {
        model: 12
        delegate: Item {
            id: petal
    ...
    Column {
        ...
        Column {
            ...
            Text {
                text: (userHelper.currentItem && userHelper.currentItem.uName) ? userHelper.currentItem.uName.toUpperCase() : "COZY USER"
