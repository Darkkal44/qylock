...
Rectangle {
    ...
    Row {
        ...
        Repeater {
            model: [{l: (sessionModel && sessionModel.count > root.sessionIndex && root.sessionIndex >= 0 ? sessionModel.get(root.sessionIndex).name : "SESSION").toUpperCase(), a: 2}, {l: "RESTART", a: 0}, {l: "POWER", a: 1}]
            delegate: Item {
